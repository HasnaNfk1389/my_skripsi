                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Materi Baru</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="container">
                                        <form action="/postNewMateri" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-75">
                                                    <input type="text" id="nama_materi" name="nama_materi" placeholder="Masukkan Judul/(BAB)">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-25">
                                                ...
                                                <div class="col-75">
                                                    <input type="text" id="deskripsi_materi" name="deskripsi_materi" placeholder="Masukkan Deskripsi Materi">
                                                </div>
                                            </div>
